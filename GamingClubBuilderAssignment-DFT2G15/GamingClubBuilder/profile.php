    ...
    <body>
        ...
        <div class="profile_row">
            <div class="profile_box">
                <div>
                    <img src="profile_background2.jpg" width="100%" >
                </div>
                <div class="col-xs-12 col-sm-12">
                    <div class="profile-picture">
                        <img class="profile_avatar" src="logo1.png" width="96" height="96" alt="Profile Pic">
                        <div class="image-upload">
                            <a href="editProfile.php"><img src="edit.png" width="35" alt="edit_picture"></a>
                        </div>
                        <?php 
                        ...
                        if ($_SESSION['admin'] == 1) {
                            ...
                            $admin = "Non-Admin";
                        ?>
                        <div class="profile-Name"><strong><?php echo ($_SESSION['username']); ?></strong></div>
                    </div>
                    <div class="profile-info">
                        <div class="profile-row">
                            <div class="profile-table-name"> Member ID </div>
                            <div class="profile-table-value"> <?php echo ($_SESSION['id']); ?> </div>
                        </div>
                        <div class="profile-row">
                            <div class="profile-table-name"> Gender </div>
                            <div class="profile-table-value"> <?php echo ($gender); ?> </div>
                        </div>
                        <div class="profile-row">
                            <div class="profile-table-name"> E-mail </div>
                            <div class="profile-table-value"> <?php echo ($_SESSION['email']); ?> </div>
                        </div>
                        <div class="profile-row">
                            <div class="profile-table-name"> Phone Number </div>
                            <div class="profile-table-value"> <?php echo ($_SESSION['memPhone']); ?> </div>
                        </div>
                        <div class="profile-row">
                            <div class="profile-table-name"> Admin Status</div>
                            <div class="profile-table-value"> <?php echo ($admin); ?> </div>
                        </div>
                        <div class="profile-row">
                            <div class="profile-table-name"> Name </div>
                            <div class="profile-table-value"> <?php echo ($_SESSION['firstName']); ?> </div>
                        </div>
                    </div>
                </div>
            </div>
