...
<html>
    <head>
        ...
        $id=0;
        $id=$_GET['id'];
        $sql3="SELECT N_Notice_Desc from notice where N_Notice_ID='$id' ";
        ...
        <div class="admin-container">
            ...
            <div class="table-all-user p-3 mb-5 rounded">
                ...
                <table id="editable_table" class="table table-bordered">
                    <form action="update_notice.php?id=<?php echo $id; ?>" method="POST"> 
                        <label>Desc: </label> <input type="text" value="<?php echo $row['N_Notice_Desc']; ?>" name="desc">
