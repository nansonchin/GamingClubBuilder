...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $ticket1 = $_POST['normal_ticket'];
    $ticket2 = $_POST['premium_ticket'];
    $ticket3 = $_POST['vip_ticket'];

    $priceTicket1 = $ticket1 * 100;
    $priceTicket2 = $ticket2 * 300;
    $priceTicket3 = $ticket3 * 500;
    $totalTicket = $ticket1 + $ticket2 + $ticket3;
    $totalPrice = $priceTicket1 + $priceTicket2 + $priceTicket3;
    
    $_SESSION["normal_ticket"] = $ticket1;
    $_SESSION["premium_ticket"] = $ticket2;
    $_SESSION["vip_ticket"] = $ticket3;
    $_SESSION["totalPrice"] = $totalPrice;
    $_SESSION["totalTicket"] = $totalTicket;
    ...
    <body>
        ...
        <div class="nav">
            ...
            <nav class="nav-contain">
                ...
                <a href="ticket.php" class="nav_cart">TICKET</a>
        ...
        <form name="ticketForm" action="<?= $_SERVER['PHP_SELF'] ?>" method="POST">
            <div class="ticket_row">
                ...
                <div class="ticket_field">
                    <div class="card">
                        <img src="ticketPicture1-1.jpg" alt="ticket1" style="width:100%">
                        <h1>Normal Ticket</h1>
                        <p class="price">RM100</p>
                        <p>Normal ticket include a cup of drinks and free seat at normal spectator area.</p>
                        <p><select name="normal_ticket" id="normal_ticket">
                    ...
                    <div class="card">
                        <img src="ticketPicture2.jpg" alt="ticket2" style="width:100%">
                        <h1>Premium Ticket</h1>
                        <p class="price">RM300</p>
                        <p>The Premium ticket include a set of food and drinks and a glow stick with the priority to sit at the premium seat area.</p>
                        <p><select name="premium_ticket" id="premium_ticket">
                                <option value="0">0</option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                    ...
                    <div class="card">
                        <img src="ticketPicture2.jpg" alt="ticket3" style="width:100%">
                        <h1>V.I.P Ticket</h1>
                        <p class="price">RM500</p>
                        <p>V.I.P ticket include a set of food and drinks, a grow stick with the priority to sit at the V.I.P seat area and a change to taking photograph with the day's MVP player.</p>
                        <p><select name="vip_ticket" id="vip_ticket">
                                <option value="0">0</option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                ...
                <div class="ticket_button">
                    <div class="d-grid gap-2 col-6 mx-auto">
                        <a href="payment.php"><input type="submit" value="Proceed to Payment" class="btn btn-primary"></a>
                    </div>
                </div>
            </div>
        </form>
