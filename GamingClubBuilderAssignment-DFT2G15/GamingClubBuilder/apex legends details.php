      ...
      <div class="container">
        <div class="section-header">
          ...
          <p>Here is our Event details</p>
            ...
            <img src="apex.jpg" alt="Event 1" width="1170">
            <div class="details">
              <h2>Apex Legends</h2>
              </div>
              <p>Check out the Apex Legends Global Series competition calendar. </p>
 
              <p>Learn more about the dates and locations of each of our events in Year 2 of the ALGS.</p> 

              <p>Four weeks of online Preseason Qualifiers to determine which 8 teams from each region will qualify</p>
              <p>to begin Split 1 competing in the Pro League, joining 22 other directly invited teams (per region)</p>
            </div>
          </div>
