...
<html>
    <head>
        ...
        $id2=0;
        $id2=$_GET['id2'];
        $sql3="SELECT Payment_Status from ticket where TCK_ID='$id2' ";
        ...
        <div class="admin-container">
            ...
            <div class="table-all-user p-3 mb-5 rounded">
                ...
                <table id="editable_table" class="table table-bordered">
                    <form action="update-valorant.php?id2=<?php echo $id2; ?>" method="POST"> 
                        <label>Payment Status: </label> <input type="text" value="<?php echo $row['Payment_Status']; ?>" name="vestatus">
                        <br>
